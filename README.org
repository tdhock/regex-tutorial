...
** Coding project: polynomial time named capture
...
expression engines can have an exponential runtime. One way to achieve
a speedup is to drop backreference support and use the [[https://github.com/google/re2][re2]] C++
